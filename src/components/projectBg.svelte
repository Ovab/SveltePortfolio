<script lang="ts">
    ...
    import projectState from '$lib/json/ProjectPageAnime.json'
    ...
    onMount(() => {
        if (browser) {
            ...
            const project = getProject('ProjectPage', {state: projectState})
            const sheet = project.sheet('Project Scene')
            ...
            loader.load('assets/ProjectBoardRoom.glb', function (gltf) {
